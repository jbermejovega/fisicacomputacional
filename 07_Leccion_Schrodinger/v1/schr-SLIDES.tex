...
\section{Problemas}
\begin{itemize}
\item{\ro{\it Obligatorio:}} Resolver la ecuaci{\'o}n de Schr\"odinger unidimensional para un potencial cuadrado.

\item{\ro{\it Voluntario 1:}} Estudiar el \az{coeficiente de transmisi{\'o}n} (la probabilidad de encontrar a la part{\'\i}cula al
otro lado del obst{\'a}culo para tiempos largos pero antes de que se refleje en la pared derecha) en funci{\'o}n
del par{\'a}metro del potencial $\lambda$, para valores positivos y negativos. Estudiar la dependencia en $N$ del coeficiente de transmision realizando simulaciones para $N=100$, $500$, $1000$, $5000$, $10000$.
\az{Estudiar lo mismo para un potencial escal{\'o}n y uno triangular}. Desarrollar la teor{\'\i}a y comparar con los resultados computacionales.


\item{\ro{\it Voluntario 2:}} Estudiar el oscilador arm{\'o}nico (entre paredes infinitas). Calcular el periodo en funci{\'o}n de $N$ y $k_0$. Comparar con los resultados te{\'o}ricos.
\end{itemize}
